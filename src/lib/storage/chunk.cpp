...
void Chunk::increase_invalid_row_count(const uint64_t count) const {
  std::cout << "invalid_row_count before: " << _invalid_row_count << std::endl;
  _invalid_row_count += count;
  std::cout << "invalid_row_count after: " << _invalid_row_count << std::endl;
}
